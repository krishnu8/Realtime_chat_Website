        ...
        <div class="container" style="margin-top: 20px;">
            <div class="row">
                    ...
                    <div class="input-group" style="margin-bottom:10px;">
                        <form action="Search_Add_friend" method="GET" class="input-group">
                            <div class="form-outline" style="width: 90%;">
                                <input id="search" type="search" id="form1" name="search_name" class="form-control"
                ...
                <div class="col-sm-12" style="margin-bottom: 10px">
                    @if ($friend_request_receive_count != 0)
                        <div id="fb">
                            <div id="fb-top">
                                <p><b>Friend Requests</b>
                            </div>
                            @foreach ($friend_request_receive1 as $request_receive)
                                <div class="info" aria-labelledby="navbarDropdown">
                                    <img src="{{ URL::to('/') }}/pictures/{{ $request_receive['Picture'] }}" height="50px" width="50px" alt="Image of woman"
                                        class="iimg">
                                    <p><b>{{$request_receive['Name']}}</b> <br>
                                    <div> <a href="{{ URL::to('/') }}/confirm_request/{{ $request_receive['User_id'] }}" class="btn btn-info">Confirm Request</a></div>
                                    <div><a href="{{ URL::to('/') }}/Delete_request/{{ $request_receive['User_id'] }}" class="btn btn-warning">Delete Request</a></div>
                                </div>
                                <hr class="hrrr">
                            @endforeach
                        </div>
                    ...
                    <div class="col-lg-3 caa">
                        <a href="{{ URL::to('/') }}/profile/{{ $user['User_id'] }}" class="caa">
                            <div class="card card-one">
                                <div class="header">
                                    <div class="avatar">
                                        <img src="{{ URL::to('/') }}/pictures/{{ $user['Picture'] }}" alt="">
                                    </div>
                                </div>
                                <h3>{{ $user['Name'] }}</h3>
                                <div class="desc">
